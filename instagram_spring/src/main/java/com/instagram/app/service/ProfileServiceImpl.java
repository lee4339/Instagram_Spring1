...
public class ProfileServiceImpl implements ProfileService {
	...
	public AccountResponseDto getAccountProfile(int usercode) {
		System.out.println(profileRepository.getAccountProfileByUsercode(usercode));
	...
	public boolean updatePassword(User user, PasswordUpadteReqDto passwordUpadteReqDto) {
		...
		user.setPassword(BCrypt.hashpw(passwordUpadteReqDto.getNewPassword(), BCrypt.gensalt()));
